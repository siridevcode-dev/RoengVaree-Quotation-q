...
export default function HRPayroll() {
 ...
 <button title="ปุ่ม" onClick={() => setSelectedPeriodDetails(null)} className="hover:text-indigo-600 transition-colors">เงินเดือน</button>
 <span>&gt;</span>
 ...
 <div className="flex items-center gap-3">
 <button title="ปุ่ม" onClick={() => setIsHiddenAmounts(!isHiddenAmounts)}
 ...
 <div className="flex items-center gap-3">
 <button title="ปุ่ม" className="flex items-center gap-2 px-4 py-2.5 bg-slate-50 hover:bg-slate-100 text-slate-600 border border-slate-200 rounded-2xl text-[13.5px] font-bold transition-all active:scale-95">
 ...
 <>
 <div>
 <button title="ปุ่ม" className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200/80 rounded-xl text-[13px] font-bold transition-all shadow-sm active:scale-95">
 <svg className="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <div className="flex items-center gap-3">
 <button title="ปุ่ม" onClick={handleCalculate} className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200/80 rounded-xl text-[13px] font-bold transition-all shadow-sm active:scale-95">
 <svg className="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <button title="ปุ่ม" onClick={() => isCalculated && setWorkflowStep(2)} 
 ...
 <>
 <div>
 <button title="ปุ่ม" onClick={() => setWorkflowStep(1)} className="flex items-center gap-2 px-5 py-2 bg-white hover:bg-slate-50 text-sky-500 border border-sky-400/60 rounded-xl text-[13px] font-bold transition-all shadow-sm active:scale-95">
 <span>ย้อนกลับ</span>
 </button>
 </div>
 ...
 <button title="ปุ่ม" onClick={() => setWorkflowStep(3)} className="flex items-center gap-2 px-5 py-2 bg-[#0EA5E9] hover:bg-[#0EA5E9]/90 text-white rounded-xl text-[13px] font-bold transition-all shadow-md shadow-sky-500/10 active:scale-95">
 <span>อนุมัติ</span>
 ...
 <>
 <div>
 <button title="ปุ่ม" onClick={() => setWorkflowStep(2)} className="flex items-center gap-2 px-6 py-2 bg-white hover:bg-sky-50/50 text-[#0EA5E9] border border-[#0EA5E9] rounded-xl text-[13px] font-black transition-all shadow-sm active:scale-95">
 <span>ย้อนกลับ</span>
 </button>
 </div>
 ...
 <button title="ปุ่ม" onClick={() => setActiveEditingEarning(null)} className="hover:text-indigo-600 transition-colors font-bold">
 เงินได้/เงินหัก
 </button>
 <svg className="w-3 h-3 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" />
 ...
 <button title="ปุ่ม" onClick={() => setActiveEditingEarning(null)}
 ...
 <button title="ปุ่ม" className="flex items-center gap-2 px-4 py-2 bg-slate-50 hover:bg-slate-100 border border-slate-200/60 text-slate-600 rounded-2xl text-[13px] font-bold transition-all">
 ...
 <button title="ปุ่ม" className="flex-1 text-center py-2 bg-white shadow-sm rounded-[10px] text-[12.5px] font-black text-[#0EA5E9]">
 พนักงานทุกคน
 </button>
 <button title="ปุ่ม" className="flex-1 text-center py-2 text-[12.5px] font-bold text-slate-500 hover:text-slate-700">
 กำหนดเอง
 </button>
 </div>
 <button title="ปุ่ม" className="p-2 bg-white hover:bg-slate-50 border border-slate-200/60 rounded-xl text-slate-400 hover:text-slate-600 transition-all shadow-sm">
 <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <button title="ปุ่ม" className="text-[#0EA5E9] hover:underline text-[13px] font-bold flex items-center gap-1 mt-2 self-start">
 ⓘ ดูสูตรคำนวณ
 </button>
 </div>
 </div>
 ...
 <button title="ปุ่ม" onClick={() => setWelfareMonthlyEligible("พนักงานทุกคน")}
 ...
 <button title="ปุ่ม" onClick={() => setWelfareMonthlyEligible("กำหนดเอง")}
 ...
 <button title="ปุ่ม" onClick={() => setWelfareMonthlyCalcType("รายเดือน")}
 ...
 <button title="ปุ่ม" onClick={() => setWelfareMonthlyCalcType("คิดตามวันทำงาน")}
 ...
 <button title="ปุ่ม" className="text-[#0EA5E9] hover:underline text-[12px] font-bold flex items-center gap-1 self-start">
 ⓘ ดูสูตรคำนวณ
 </button>
 </div>
 )}
 ...
 <button title="ปุ่ม" className="flex items-center gap-2 text-[#0EA5E9] hover:text-[#0284C7] text-[13px] font-bold mt-1 self-start">
 ...
 <button title="ปุ่ม" key={idx} className={`flex-1 text-center py-2 rounded-[10px] text-[12.5px] font-black ${tab === "พนักงานทุกคน" ? "bg-white shadow-sm text-[#0EA5E9]" : "text-slate-400 hover:text-slate-600"}`}>
 {tab}
 </button>
 ))}
 </div>
 ...
 <button title="ปุ่ม" key={idx} className={`flex-1 text-center py-2 rounded-[10px] text-[12.5px] font-black ${tab === "กำหนดวงเงิน" ? "bg-white shadow-sm text-[#0EA5E9]" : "text-slate-400 hover:text-slate-600"}`}>
 {tab}
 </button>
 ))}
 </div>
 ...
 <div className="flex bg-slate-100/80 p-0.5 rounded-xl border border-slate-200/30 max-w-xs">
 {["กำหนดวงเงิน", "คิดตามวันทำงาน"].map((tab, idx) => (
 <button title="ปุ่ม" key={idx} className={`flex-1 text-center py-2 rounded-[10px] text-[12.5px] font-black ${tab === "คิดตามวันทำงาน" ? "bg-white shadow-sm text-[#0EA5E9]" : "text-slate-400 hover:text-slate-600"}`}>
 {tab}
 </button>
 ))}
 </div>
 ...
 <div className="flex items-center gap-3">
 <button title="ปุ่ม" className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-slate-50 text-slate-600 border border-slate-200 rounded-xl text-[12.5px] font-bold shadow-sm transition-all">
 <svg className="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <button title="ปุ่ม" key={idx} className={`flex-1 text-center py-2 rounded-[10px] text-[12.5px] font-black ${tab === "ตามค่าจ้าง" ? "bg-white shadow-sm text-[#0EA5E9]" : "text-slate-400 hover:text-slate-600"}`}>
 {tab}
 </button>
 ))}
 </div>
 ...
 <button title="ปุ่ม" className="text-[#0EA5E9] hover:underline text-[13px] font-bold flex items-center gap-1 mt-4 self-start">
 ⓘ ดูสูตรคำนวณ
 </button>
 </div>
 ...
 <div className="flex bg-slate-100/80 p-0.5 rounded-xl border border-slate-200/30 mt-2 max-w-lg">
 {["ตามค่าจ้าง", "รายครั้ง", "เป็นรอบๆ", "ขั้นบันได (ต่อครั้ง)"].map((tab, idx) => (
 <button title="ปุ่ม" key={idx} className={`flex-1 text-center py-2 rounded-[10px] text-[12.5px] font-black ${tab === "ขั้นบันได (ต่อครั้ง)" ? "bg-white shadow-sm text-[#0EA5E9]" : "text-slate-400 hover:text-slate-600"}`}>
 {tab}
 </button>
 ))}
 </div>
 ...
 {i > 0 && (
 <button title="ปุ่ม" className="p-2 text-slate-300 hover:text-rose-500 transition-colors">
 <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <button title="ปุ่ม" className="flex items-center gap-2 text-[#0EA5E9] hover:text-[#0284C7] text-[13px] font-bold mt-2 self-start">
 <span className="w-6 h-6 border-2 border-dashed border-[#0EA5E9] rounded-xl flex items-center justify-center">+</span>
 <span>เพิ่ม</span>
 </button>
 ...
 <div className="bg-white border-b border-slate-200/60 px-10 py-4 flex-shrink-0 flex items-center justify-between">
 <div className="flex items-center gap-2">
 <button title="ปุ่ม" onClick={() => setEarningsTab("เงินได้")}
 ...
 <button title="ปุ่ม" onClick={() => setEarningsTab("เงินหัก")}
 className={`relative px-6 py-3 text-[14px] font-black transition-all flex items-center gap-2 ${
 ...
 {/* Close button */}
 <button title="ปุ่ม" onClick={() => setIsEarningsSettingsOpen(false)}
 className="p-2 rounded-xl hover:bg-slate-50 text-slate-400 hover:text-slate-600 transition-colors shadow-sm border border-slate-100 bg-white"
 >
 <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
 ...
 <button title="ปุ่ม" onClick={() => setActiveEditingEarning("create_new")}
 ...
 <button title="ปุ่ม" onClick={() => setActiveEditingEarning(item.name)} 
 ...
 <button title="ปุ่ม" onClick={() => setPaymentFrequency("เดือนละ 1 ครั้ง")}
 ...
 <button title="ปุ่ม" onClick={() => setPaymentFrequency("เดือนละ 2 ครั้ง")}
 className={`flex-1 text-center py-2.5 rounded-xl text-[13px] flex items-center justify-center gap-1 transition-all duration-200 ${
 ...
 {payType === "รายวัน" && (
 <button title="ปุ่ม" onClick={() => setPaymentFrequency("ทุกสัปดาห์")}
 className={`flex-1 text-center py-2.5 rounded-xl text-[13px] flex items-center justify-center gap-1 transition-all duration-200 ${
 ...
 <button title="ปุ่ม" className="flex-1 text-center py-2 bg-white shadow-sm rounded-xl text-[13px] font-black text-[#0EA5E9] border border-slate-100">
 ทุกคน
 </button>
 <button title="ปุ่ม" className="flex-1 text-center py-2 text-slate-500 text-[13px] font-bold hover:text-slate-700 transition-colors">
 กำหนดเอง
 </button>
 </div>
 <button 
 ...
 <button title="ปุ่ม" onClick={() => setIsCreatingPeriod(false)}
 ...
 <button title="ปุ่ม" onClick={() => setIsYearDropdownOpen(!isYearDropdownOpen)}
 ...
 <button title="ปุ่ม" onClick={() => setIsEarningsSettingsOpen(true)}
 ...
 {activeTab !== "เงินสะสมประจำปี" && activeTab !== "ตั้งค่าสลิปเงินเดือน" && (
 <div className="relative">
 <button title="ปุ่ม" onClick={() => setIsCreatePeriodDropdownOpen(!isCreatePeriodDropdownOpen)}
 ...
 <button title="ปุ่ม" onClick={() => setToast("นำเข้าเงินสะสมประจำปีสำเร็จ")}
 className="flex items-center gap-2 px-5 py-2.5 bg-[#0EA5E9] hover:bg-sky-600 text-white rounded-[16px] text-[13.5px] font-black transition-all shadow-lg shadow-sky-100 active:scale-95"
 >
 <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <button title="ปุ่ม" onClick={() => setAllowEmployeeViewSlip(!allowEmployeeViewSlip)}
 ...
 <button title="ปุ่ม" onClick={() => setIsStatusDropdownOpen(!isStatusDropdownOpen)}
 ...
 <button title="ปุ่ม" onClick={() => setAllowEmailDelivery(!allowEmailDelivery)}
 className={`w-12 h-6 flex items-center rounded-full p-1 transition-all duration-300 ${
 ...
 <button title="ปุ่ม" onClick={() => setIsCreatingSupplementaryPeriod(false)}
