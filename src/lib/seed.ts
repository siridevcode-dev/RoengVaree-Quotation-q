...
export async function seedDatabase(db: Client) {
  ...
  const productsData = [
    ...
    ["Speed Boat R33", "เรือ", 1500000, "ลำ", "เรือสปีดโบ๊ท รุ่น R33", "BOAT-R33", 1, "R33"],
    ...
    // Engines
    ["Honda Marine BF350 V8", "เครื่องยนต์", 3000000, "ชุด", "เครื่องยนต์ Honda Marine BF350 V8", "ENG-HONDA-BF350", 1, "ทุกรุ่น"],
